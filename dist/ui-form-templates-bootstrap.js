angular.module('ui.form').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui-form/field-choice/field-choice.html',
    ...
    "        <option value=\"\" ng-if=\"!vm.required()\">{{ 'ui.form.field.choice.unselected_option'|translate }}</option>\n" +
    "    </select>\n" +
    "\n" +
    ...
    "         class=\"form\">\n" +
    "        <div ng-if=\"!vm.required()\">\n" +
    "            <input type=\"radio\" ng-model=\"vm.data\" value=\"null\"> {{ option[vm.labelProperty] | translate }}\n" +
    "        </div>\n" +
    "        <label ng-repeat=\"option in vm.options\">\n" +
    "            <input type=\"radio\" ng-model=\"vm.data\" ng-disabled=\"vm.disabled\" value=\" {{ option[vm.valueProperty].toString() }} \"> {{ option[vm.labelProperty] | translate }}\n" +
    "        </label><br />\n" +
    "    </div>\n" +
    "\n" +
    ...
    "         class=\"form\">\n" +
    "        <label ng-repeat=\"option in vm.options\">\n" +
    "            <input type=\"checkbox\" ng-model=\"vm.data[$index]\" ng-disabled=\"vm.disabled\" value=\" {{ option[vm.valueProperty].toString() }} \"> {{ option[vm.labelProperty] | translate }}\n" +
    "        </label><br />\n" +
    "    </div>\n" +
    "\n" +
  ...
  $templateCache.put('ui-form/field-number/field-number.html',
    "<ui-field-row>\n" +
    "    <div ng-class=\"{ 'input-group': vm.append() || vm.prepend() }\">\n" +
  ...
  $templateCache.put('ui-form/field-password/field-password.html',
    ...
    "        <input class=\"form-control\" type=\"{{vm.mode}}\" ng-model=\"vm.data\">\n" +
    "        <span class=\"input-group-btn\">\n" +
    "            <button class=\"btn btn-default\"\n" +
    "                    ng-click=\"vm.toggleMode()\">\n" +
    "                 <i class=\"glyphicon\"\n" +
    "                    ng-class=\"{'glyphicon-eye-open': vm.mode === 'password', 'glyphicon-eye-close': vm.mode === 'text'}\">\n" +
    "                 </i>\n" +
    "            </button>\n" +
    "        </span>\n" +
    "    </div>\n" +
