...
(function(angular) {
    ...
    uiFieldCheckbox.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldChoice.$inject = ["formFactory", "formUtil", "formApi"];
...
(function(angular) {
    ...
    uiFieldCollection.$inject = ["formFactory", "formUtil"];
...
(function(angular) {
    ...
    uiFieldColor.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldDatepicker.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldEditor.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldEmail.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldImage.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldImagePreview.$inject = ["mOxie"];
...
(function(angular) {
    ...
    uiFieldImageUploader.$inject = ["$window", "plupload", "$translate", "formUtil", "apiRouting"];
...
(function(angular) {
    ...
    uiFieldNumber.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldPassword.$inject = ["formFactory"];
...
(function(angular) {
    ...
    uiFieldTab.$inject = ["formFactory", "formApi", "formUtil"];
...
(function(angular) {
    ...
    uiFieldText.$inject = ["$timeout", "formUtil", "formFactory"];
...
(function(angular) {
    ...
    uiFieldTextarea.$inject = ["$timeout", "formUtil", "formFactory"];
...
(function(angular) {
    ...
    uiFieldTree.$inject = ["$q", "formFactory", "formUtil", "formApi"];
...
(function(angular) {
    ...
    uiFieldUnitValue.$inject = ["formFactory", "localStorageService"];
...
(function(angular) {
    ...
    formFactory.$inject = ["$templateCache", "$compile", "formUtil"];
...
(function(angular) {
    ...
    formUtil.$inject = ["$injector", "$parse"];
...
(function(angular) {
    ...
    FormController.$inject = ["$rootScope", "$scope", "$element", "formUtil"];
